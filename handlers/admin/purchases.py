...
async def approve_purchase_cb(call: CallbackQuery, db_user: User, bot: Bot):
    ...
    # Har bir kurs uchun alohida invite link + kurator xabari
    KURATOR_TEXT = (
        "\n\n📌 <b>Kurs bo'yicha qo'shimcha savollar bo'lsa kuratorga yozishingiz mumkin:</b>\n"
        "👩‍🏫 Kurator: @A_Zakhidovnaa"
    )
    for cd in course_data:
        ...
        # Kanal havolasi bilan birga kurator xabari ham yuboriladi
        link_text += KURATOR_TEXT
